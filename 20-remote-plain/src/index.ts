...
export class MyMCP extends McpAgent {
  ...
  cartStorage: Map<string, Cart> = new Map();
  cartApi = new CartApi(this.cartStorage);
    ...
    this.server.registerTool(
      ...
      async (args) => {
        ...
        try {
          const cart = this.cartApi.addToCart(username, articleNumber, quantity);
    ...
    this.server.registerTool(
      ...
      async (args) => {
        ...
        try {
          const cart = this.cartApi.addMultipleToCart(username, normalizedPositions);
    ...
    this.server.registerTool(
      ...
      async (args) => {
        ...
        const cart = await this.cartApi.getCart(username);
    ...
    this.server.registerTool(
      ...
      async (args) => {
        ...
        try {
          const orderId = this.cartApi.submitCart(username);
